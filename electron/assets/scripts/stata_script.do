...
global fileDir "C:\Users\lokalAdmin\Desktop\TestSuite\Testtroesl\stata"
global inputStata $fileDir\stata_23765_shortdecbc
global inputStata_ "stata_23765_shortdecbc"
                       ...
                       * Write output to file
                       ...
                       filefilter $fileDir\tempB.txt $fileDir\stata_23765_shortdecbc_VARIABEL.txt, from(",$osEOL") to ("") replace
                       ...
                       * If label is empty, use default value
                       ...
                       keep v0
                       * Write output to file
                       export delimited using $fileDir\stata_23765_shortdecbc_VARIABELBESKRIVELSE.txt, delimiter(tab) novarnames nolabel replace
                       ...
                       * If value label(s) exist, create output with code list(s)
                       ...
                       keep valLabel
                       * Write output to file
                       export delimited using $fileDir\stata_23765_shortdecbc_KODELISTE.txt, delimiter(tab) novarnames nolabel replace
                       }
                       else {
                       cls
                       ...
                       */
                       ...
                       export delimited using $fileDir\$inputStata_.csv, delimiter(";") nolabel replace
