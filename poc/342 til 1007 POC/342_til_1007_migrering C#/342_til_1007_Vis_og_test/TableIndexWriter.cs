...
{	
    ...
    {  
        ...
        public void writeStartXML(XmlTextWriter xw, string dbName, string databaseProduct)
        {	
        ...
        public void writeTableIndex(XmlTextWriter xw, string tableName, string folderNum, string description)
        {
        ...
        public void writeColumn ( XmlTextWriter xw, string columnName, string columnID, string type, string typeOriginal, string nullable, string description )
        {
        ...
        /// </summary>
        /// <param name="xw">XmlWriter instans</param>
        public void writeEndColumns ( XmlTextWriter xw )
        {
        ...
        public void writePrimaryKey ( XmlTextWriter xw, string pkName, List<string> columnsPk )
        {
       ...
       /// </summary>
       /// <param name="xw">XmlWriter instans</param>
        public void writeForeignKeysStart ( XmlTextWriter xw )
        {
        ...
        public void writeForeignKey ( XmlTextWriter xw, string fkName, string referencedTable, string columnsFK, string columnsReferenced)
        {
        ...
        /// </summary>
        /// <param name="xw">XmlWriter instans</param>
        public void writeForeignKeysEnd(XmlTextWriter xw)
        {
            xw.WriteEndElement();
        }
     
        /// <summary>
        /// Afslutter en tabel i tableIndex
        /// </summary>
        /// <param name="xw">XmlWriter instans</param>
        /// <param name="rows"></param>
        public void writeEndTable ( XmlTextWriter xw, string rows )
        {
        ...
        /// </summary>
        /// <param name="xw">XmlWriter instans</param>
        public void writeEndDocument ( XmlTextWriter xw )
        {
